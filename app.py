...
#     if outcome == "Too High":
#         # FIXME: Incorrectly awards points on wrong attempts
...
if new_game:
    ...
    st.session_state.status = "playing" #allows manual play to return
...
# FIXME: Logic breaks here, secret is converted to a string, it should remain as an int
